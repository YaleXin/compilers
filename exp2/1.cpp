...
vector<int> output;
const int EOF_ID = -2021, ADD_ID = 62, SUB_ID = 63, MUL_ID = 64;
const int DIV_ID = 65, IDENTIFY_ID = 32, LEFT_ID = 39, RIGHT_ID = 40;
const int INTEGER_CONSTANTS_ID = 33, REAL_CONSTANTS_ID = 34;
